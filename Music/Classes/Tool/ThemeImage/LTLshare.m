...
+(void) drawArtboard
{
    [LTLshare drawArtboardWithFrame:CGRectMake(0, 0, 51, 49) resizing:LTLshareResizingBehaviorAspectFit];
}
...
+(void) drawArtboardWithFrame:(CGRect)frame resizing:(LTLshareResizingBehavior)resizing
{
    ...
    CGRect resizedFrame = LTLshareResizingBehaviorApply(resizing, CGRectMake(0, 0, 51, 49), frame);
...
+(UIImage *) imageOfArtboardWithSize:(CGSize)size resizing:(LTLshareResizingBehavior)resizing
{
    ...
    [LTLshare drawArtboardWithFrame:CGRectMake(0, 0, size.width, size.height) resizing:resizing];
    image = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
...
CGRect LTLshareResizingBehaviorApply(LTLshareResizingBehavior behavior, CGRect rect, CGRect target)
{
    ...
    switch (behavior)
    {
        case LTLshareResizingBehaviorAspectFit:
        {
            scales.width = MIN(scales.width, scales.height);
            scales.height = scales.width;
            break;
        }
        case LTLshareResizingBehaviorAspectFill:
        {
            scales.width = MAX(scales.width, scales.height);
            scales.height = scales.width;
            break;
        }
        case LTLshareResizingBehaviorStretch:
            break;
        
        case LTLshareResizingBehaviorCenter:
        {
            scales.width = 1;
            scales.height = 1;
            break;
