...
//    
//    _colorCircleView.centerX = self.center.x;
//    _centerCircleView.width = _centerCircleView.highly = radiusCenter;
    ///走捷径
    if ((_yuanlai.origin.x != self.frame.origin.x) || (_yuanlai.origin.y != self.frame.origin.y) || (_yuanlai.size.width != self.frame.size.width) || (_yuanlai.size.height != self.frame.size.height) ) {
